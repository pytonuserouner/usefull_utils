...
"""
Сортировка папки "Загрузки". Самый лучший скрипт в этой подборке. 
Если у вас все аниме картинки и обучающие видео перемешаны в кучу, 
то запустив скрипт на выходе получите организованное рабочее место настоящего программиста!
"""
