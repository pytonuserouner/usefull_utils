...
"""
Парсинг рейтинга фильма с IMDB. Такие парсеры всегда можно вставить в ботов для автоматического постинга на каналы, 
получается у вас уже может быть сеть из каналов про фильмы.
"""
