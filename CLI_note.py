...
"""
CLI блокнот для заметок. Каждый программист должен и калькулятор сделать и блокнот написать.
А блокнот, написанный с CLI ценнее вдвойне! Для работы надо установить click,
который помогает делать красивые интерфейсы в командной строке.
"""
